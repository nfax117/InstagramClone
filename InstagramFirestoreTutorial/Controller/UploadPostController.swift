...
//
//  Created by Nathaniel Faxon on 7/1/26.
//
...
class UploadPostController: UIViewController {
    ...
    func configureUI() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Share", style: .prominent, target: self, action: #selector(didTapDone))
